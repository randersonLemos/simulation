...
class Sector_Table:
    ...
    dic['Water Prod Rate SCTR'] = Sector_Keys.wat_prod_dot_sc()
    dic['Water Prod Cum SCTR'] = Sector_Keys.wat_prod_sc()

    dic['Oil Prod Rate SCTR'] = Sector_Keys.oil_prod_dot_sc()
    dic['Oil Prod Cum SCTR'] = Sector_Keys.oil_prod_sc()

    dic['Gas Prod Rate SCTR'] = Sector_Keys.gas_prod_dot_sc()
    dic['Gas Prod Cum SCTR'] = Sector_Keys.gas_prod_sc()

    dic['Liquid Prod Rate SCTR'] = Sector_Keys.liq_prod_dot_sc()
    dic['Liquid Prod Cum SCTR'] = Sector_Keys.liq_prod_sc()

    dic['Water Inje Rate SCTR'] = Sector_Keys.wat_inje_dot_sc()
    dic['Water Inje Cum SCTR'] = Sector_Keys.wat_inje_sc()

    dic['Oil Inje Rate SCTR'] = Sector_Keys.oil_inje_dot_sc()
    dic['Oil Inje Cum SCTR'] = Sector_Keys.oil_inje_sc()

    dic['Gas Inje Rate SCTR'] = Sector_Keys.gas_inje_dot_sc()
    dic['Gas Inje Cum SCTR'] = Sector_Keys.gas_inje_sc()

    dic['Liquid Inje Rate SCTR'] = Sector_Keys.liq_inje_dot_sc()
